  ...
  return (
    <div>
      <div className="flex flex-col max-w-3xl p-6 space-y-4 sm:p-10 dark:bg-gray-50 dark:text-gray-800">
        <h2 className="text-xl flex gap-2 font-semibold">Your cart <p className="px-4 flex justify-center  items-center font-thin rounded dark:bg-accent dark:text-gray-100">{cart.length} Items</p></h2>
                  ...
                  <div className="flex flex-col justify-between w-full pb-4">
                    <div className="flex justify-between w-full pb-2 space-x-2">
                      <div className="space-y-1">
                        ...
                        <p className="text-sm dark:text-gray-600">{item.trainerName}</p>
                      </div>
                      <div className="text-right">
                        <p className="text-lg font-semibold">{item.packagePrice}$</p>
