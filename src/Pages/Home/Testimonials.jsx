...
const Testimonials = () => {
  ...
  useEffect(() => {
    fetch("https://y-nine-azure.vercel.app/reviews")
      .then((res) => res.json())
        ...
        <Swiper navigation={true} modules={[Navigation]} className="mySwiper">
          {reviews.map((review) => (
            <SwiperSlide key={review._id}>
              <div className="px-4 py-12 rounded-t-lg sm:px-8 md:px-12 bg-white dark:bg-gray-50">
                <p className="relative px-6 py-1 text-lg italic text-center dark:text-gray-800">
                  ...
                  <svg
                    ...
                    viewBox="0 0 512 512"
                    fill="currentColor"
                    className="absolute right-0 w-8 h-8 text-violet-600 dark:text-violet-600"
                  >
              ...
              <div className="flex flex-col items-center justify-center p-8 rounded-b-lg bg-violet-600 text-white  dark:bg-violet-600 dark:text-gray-50">
                <img
                  src={review.imageURL}
                  alt=""
